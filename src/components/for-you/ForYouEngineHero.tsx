    ...
    <section className="mb-5 overflow-hidden rounded-[30px] border border-[rgba(230,255,61,0.18)] bg-[linear-gradient(160deg,rgba(230,255,61,0.07),var(--bg-secondary))] p-4 shadow-[0_18px_60px_rgba(0,0,0,0.22)] md:p-6">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2 border-t border-white/5 pt-4">
        <div className="rounded-2xl bg-black/18 p-3 ring-1 ring-white/5">
          <p className="font-display text-[18px] font-black leading-none tracking-[-0.02em] text-[var(--accent)]">{totalEntries}</p>
          <p className="gk-label mt-1">in libreria</p>
        </div>
        <div className="rounded-2xl bg-black/18 p-3 ring-1 ring-white/5">
          <p className="font-display text-[18px] font-black leading-none tracking-[-0.02em] text-[var(--text-primary)]">{railsCount}</p>
          <p className="gk-label mt-1">sezioni</p>
        </div>
        <div className="rounded-2xl bg-black/18 p-3 ring-1 ring-white/5">
          <p className="font-display text-[18px] font-black leading-none tracking-[-0.02em] text-[var(--text-primary)]">{topMatch ?? '—'}</p>
