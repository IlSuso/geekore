        ...
        <div className="p-6">
          <div className="relative">
            <textarea
              ...
              className="w-full h-40 bg-zinc-800 border border-zinc-700 rounded-2xl p-4 text-white resize-y focus:outline-none focus:border-violet-500 transition-colors"
            />
