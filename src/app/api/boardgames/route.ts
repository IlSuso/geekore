...
export async function GET(request: NextRequest) {
  ...
  if (search) {
    ...
    // Usa solo boardgamegeek.com (doc: NON usare api.geekdo.com né www.)
    const endpoints = [
    ...
    try {
      ...
      const detailXml = await bggFetch(`https://boardgamegeek.com/xmlapi2/thing?id=${ids}&type=boardgame`)
