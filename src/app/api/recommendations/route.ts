...
import { buildDiversitySlots, type GenreSlot } from '@/lib/reco/slots'
import { buildWhyV3, computeMatchScore, computeTasteProfile } from '@/lib/reco/profile'
import { fetchContinuityRecs } from '@/lib/reco/continuity'
import {
  getCurrentAnimeSeasonDates, releaseFreshnessMult,
  isAwardWorthy, runtimePenalty,
  applyFormatDiversity
} from '@/lib/reco/scoring'
import {
  CROSS_TO_IGDB_GENRE, CROSS_TO_IGDB_THEME, IGDB_VALID_GENRES,
  TMDB_GENRE_MAP, TMDB_TV_GENRE_MAP,
