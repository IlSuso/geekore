          ...
          <input
            ...
            className={`w-full rounded-xl pl-10 pr-20 py-2.5 text-[15px] outline-none transition-colors ${
              isListening
                ...
                : 'bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:border-transparent focus:shadow-[0_0_0_2px_rgb(139,92,246)] focus:outline-none'
            }`}
