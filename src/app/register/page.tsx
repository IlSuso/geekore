    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] bg-[#080810] flex items-center justify-center p-6">
        <div className="text-center max-w-md mx-auto">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-3">Controlla la tua email</h1>
          ...
          <div className="space-y-3 text-sm text-zinc-500 mb-10">
            <div className="flex items-center gap-2 justify-center">
              ...
              <span>Clicca il link nell'email per attivare l'account</span>
            </div>
            <div className="flex items-center gap-2 justify-center">
              <CheckCircle size={14} className="text-emerald-500" />
      ...
      <div className="hidden lg:flex lg:w-[45%] relative flex-col justify-between p-16 overflow-hidden border-r border-zinc-800/50">
        ...
        <div className="relative space-y-6">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">
            Crea il tuo profilo geek, traccia i tuoi progressi e scopri cosa stanno guardando e giocando gli altri.
          </p>
          <div className="flex flex-wrap gap-2 pt-2">
            {['Gratis', 'Nessuna pubblicità', 'Open Source', 'Privacy first'].map(tag => (
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-500">Unisciti alla community di Geekore</p>
          </div>
