          ...
          {isEN ? (
            <>
                ...
                <div className="mt-4 bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-zinc-800">
                      <tr><td className="px-4 py-3 font-mono text-xs text-[var(--accent)]">sb-*</td><td className="px-4 py-3">Authentication session (Supabase)</td><td className="px-4 py-3">Session / 7 days</td></tr>
                      <tr><td className="px-4 py-3 font-mono text-xs text-[var(--accent)]">geekore_locale</td><td className="px-4 py-3">Language preference (localStorage)</td><td className="px-4 py-3">Persistent</td></tr>
                    </tbody>
                  </table>
                </div>
              </section>
              ...
              <section>
                ...
                <p>You can clear cookies at any time through your browser settings. Clearing authentication cookies will log you out of Geekore. The language preference is stored in <code className="text-[var(--accent)] bg-zinc-900 px-1 rounded">localStorage</code> and can be cleared from browser developer tools or changed in Settings.</p>
              </section>
            </>
          ) : (
            <>
              ...
              <section>
                ...
                <div className="mt-4 bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-zinc-800">
                      <tr><td className="px-4 py-3 font-mono text-xs text-[var(--accent)]">sb-*</td><td className="px-4 py-3">Sessione di autenticazione (Supabase)</td><td className="px-4 py-3">Sessione / 7 giorni</td></tr>
                      <tr><td className="px-4 py-3 font-mono text-xs text-[var(--accent)]">geekore_locale</td><td className="px-4 py-3">Preferenza lingua (localStorage)</td><td className="px-4 py-3">Persistente</td></tr>
                    </tbody>
                  </table>
                </div>
              </section>
              ...
              <section>
                ...
                <p>Puoi cancellare i cookie in qualsiasi momento tramite le impostazioni del browser. La cancellazione dei cookie di autenticazione comporterà il logout da Geekore. La preferenza della lingua è memorizzata nel <code className="text-[var(--accent)] bg-zinc-900 px-1 rounded">localStorage</code> e può essere cancellata dagli strumenti di sviluppo del browser o modificata nelle Impostazioni.</p>
              </section>
            </>
          )}
        </div>
