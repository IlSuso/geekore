          ...
          {isEN ? (
            <>
              ...
              <section>
                ...
                <p>Questions about these Terms: <a href="mailto:support@geekore.app" className="hover:underline" style={{ color: 'var(--accent)' }}>support@geekore.app</a></p>
              </section>
            </>
          ) : (
            <>
              ...
              <section>
                ...
                <p>Domande su questi Termini: <a href="mailto:support@geekore.app" className="hover:underline" style={{ color: 'var(--accent)' }}>support@geekore.app</a></p>
              </section>
            </>
          )}
        </div>
