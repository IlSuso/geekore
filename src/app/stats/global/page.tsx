    ...
    <div className="min-h-screen bg-black text-white pb-24">
      <div className="max-w-screen-2xl mx-auto px-4 pt-8">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 mb-8">
          ...
          {[
            { label: 'Anime', hours: stats.animeHours, color: 'bg-sky-500', max: Math.max(stats.animeHours, stats.gameHours, stats.tvHours, stats.movieHours, stats.mangaHours) },
            { label: 'Videogiochi (Steam)', hours: stats.gameHours, color: 'bg-green-500', max: Math.max(stats.animeHours, stats.gameHours, stats.tvHours, stats.movieHours, stats.mangaHours) },
            { label: 'Serie TV', hours: stats.tvHours, color: 'bg-purple-500', max: Math.max(stats.animeHours, stats.gameHours, stats.tvHours, stats.movieHours, stats.mangaHours) },
            { label: 'Film', hours: stats.movieHours, color: 'bg-red-500', max: Math.max(stats.animeHours, stats.gameHours, stats.tvHours, stats.movieHours, stats.mangaHours) },
            { label: 'Manga', hours: stats.mangaHours, color: 'bg-orange-500', max: Math.max(stats.animeHours, stats.gameHours, stats.tvHours, stats.movieHours, stats.mangaHours) },
