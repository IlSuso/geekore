    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-3xl mx-auto px-6 pt-10 pb-24">
          ...
          {isEN ? (
            <>
              <section>
                ...
                <p>Geekore is operated as a personal project. For data-related requests, contact us at: <a href="mailto:privacy@geekore.app" className="text-[#E6FF3D] hover:underline">privacy@geekore.app</a></p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><strong>Supabase</strong> (database, authentication, storage) — EU data hosting available. <a href="https://supabase.com/privacy" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>TMDb</strong> — used for news/discover (we fetch data; no user data is sent). <a href="https://www.themoviedb.org/privacy-policy" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>AniList</strong> — used for anime/manga data (read-only). <a href="https://anilist.co/terms" target="_blank" className="text-[#E6FF3D] hover:underline">Terms</a></li>
                  <li><strong>IGDB / Twitch</strong> — used for game data (read-only). <a href="https://www.twitch.tv/p/en/legal/privacy-notice/" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>Steam / Valve</strong> — optional. Used only if you connect your account. <a href="https://store.steampowered.com/privacy_agreement/" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-3">To exercise these rights, contact us at <a href="mailto:privacy@geekore.app" className="text-[#E6FF3D] hover:underline">privacy@geekore.app</a>. You may also lodge a complaint with your national data protection authority.</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-white mb-3">7. Cookies</h2>
                <p>We use only strictly necessary cookies for authentication (session management). We do not use tracking, analytics, or advertising cookies. See our <Link href="/cookies" className="text-[#E6FF3D] hover:underline">Cookie Policy</Link>.</p>
              </section>
            ...
            <>
              <section>
                ...
                <p>Geekore è gestito come progetto personale. Per richieste relative ai dati personali contattaci a: <a href="mailto:privacy@geekore.app" className="text-[#E6FF3D] hover:underline">privacy@geekore.app</a></p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><strong>Supabase</strong> (database, autenticazione, storage) — hosting UE disponibile. <a href="https://supabase.com/privacy" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>TMDb</strong> — usato per news/scoperta (recuperiamo dati; nessun dato utente viene inviato). <a href="https://www.themoviedb.org/privacy-policy" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>AniList</strong> — usato per dati anime/manga (sola lettura). <a href="https://anilist.co/terms" target="_blank" className="text-[#E6FF3D] hover:underline">Termini</a></li>
                  <li><strong>IGDB / Twitch</strong> — usato per dati videogiochi (sola lettura). <a href="https://www.twitch.tv/p/en/legal/privacy-notice/" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                  <li><strong>Steam / Valve</strong> — opzionale. Usato solo se colleghi il tuo account. <a href="https://store.steampowered.com/privacy_agreement/" target="_blank" className="text-[#E6FF3D] hover:underline">Privacy Policy</a></li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-3">Per esercitare questi diritti contattaci a <a href="mailto:privacy@geekore.app" className="text-[#E6FF3D] hover:underline">privacy@geekore.app</a>. Hai inoltre il diritto di presentare reclamo al Garante per la Protezione dei Dati Personali (<a href="https://www.garanteprivacy.it" target="_blank" className="text-[#E6FF3D] hover:underline">garanteprivacy.it</a>).</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-white mb-3">7. Cookie</h2>
                <p>Utilizziamo esclusivamente cookie strettamente necessari per l'autenticazione (gestione della sessione). Non utilizziamo cookie di tracciamento, analytics o pubblicità. Vedi la nostra <Link href="/cookies" className="text-[#E6FF3D] hover:underline">Cookie Policy</Link>.</p>
              </section>
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-wrap gap-4 text-sm text-zinc-500">
          ...
          <Link href="/cookies" className="hover:text-[#E6FF3D] transition-colors">
            Cookie Policy
          </Link>
