...
const translations = {
  it: {
    ...
    discover: {
      ...
      boardgameNote: 'Il board game verrà aggiunto alla tua collezione.',
      adding: 'Aggiungendo...',
    ...
    media: {
      ...
      typeLabels: { anime: 'Anime', manga: 'Manga', game: 'Game', tv: 'Serie', movie: 'Film', boardgame: 'Board' },
    },
    toasts: {
    ...
    forYou: {
      ...
      emptyState: 'Aggiungi almeno 5 titoli con un voto alla tua collezione per abilitare i consigli personalizzati.',
  ...
  en: {
    ...
    discover: {
      ...
      boardgameNote: 'The board game will be added to your collection.',
      adding: 'Adding...',
    ...
    media: {
      ...
      typeLabels: { anime: 'Anime', manga: 'Manga', game: 'Game', tv: 'TV', movie: 'Movie', boardgame: 'Board' },
    },
    toasts: {
    ...
    forYou: {
      ...
      emptyState: 'Add at least 5 rated titles to your collection to enable personalized recommendations.',
