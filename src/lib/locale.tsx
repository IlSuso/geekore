...
const translations = {
  it: {
    ...
    steam: {
      ...
      reorderBtn: 'Ordina per ore',
      reordering: 'Riordino...',
      connected: 'Account connesso',
      notConnected: 'Nessun account Steam collegato',
      connectHint: 'Collega il tuo account Steam dalle',
      connectSettings: 'impostazioni',
    },
    legal: {
  ...
  en: {
    ...
    steam: {
      ...
      notConnected: 'No Steam account linked',
      connectHint: 'Link your Steam account in',
